...
<?php include("includes/header.php"); ?>
	...
	<article class="section clearfix">
		...
		<h2>The Ampersand website has been designed and built to be accessible to as wide an audience as possible. Some people with disabilities find using the web difficult and while we know that it is impossible to design a site that everyone can use, if you have problems using our site, please <a href="mailto:ampersand@clearleft.com">let us know</a> and we will do our utmost to help</h2>
