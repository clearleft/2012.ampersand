...
<?php include("includes/header-".$lang.".php"); ?>
	...
	<article class="section session clearfix">
		...
		<aside class="speaker clearfix no-rule">
			<img src="img/veronika.gif" alt="Veronika Burian" width="185" height="196" />
