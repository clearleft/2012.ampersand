...
fitText(document.getElementById('mainTitle'), 0.535);
fitText(document.getElementById('description'), 1.15);
fitText(document.getElementById('whereWhen'), 1.5);
fitText(document.getElementById('ticketInfo'), 1.1);
if(document.getElementById('speakersTitle')){
	fitText(document.getElementById('speakersTitle'), 1.8);
}
if(document.getElementById('speakersList')){
	fitText(document.getElementById('speakersList'), 5.3);
}
fitText(document.getElementById('sponsorsTitle'), 1.6);
