...
<?php include("includes/header.php"); ?>
	...
	<article class="section session clearfix">
		...
		<hgroup>
			<h1 id="sessionTitle" >Linotype the Film Q&amp;A.</h1>
		...
		<aside class="speaker clearfix">
			...
			<p>Doug Wilson comes to the film from a background of graphic design and letterpress printing. He has a BFA in Graphic Design and has worked as a university typography instructor. He loves travel and long walks on the beach. This is his first film.</p>   
			<nav >
				<ul >
